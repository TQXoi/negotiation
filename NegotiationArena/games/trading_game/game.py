...
class TradingGame(AlternatingGameEndsOnTag):
    def __init__(
        ...
        **kwargs
        ...
        # AlternatingGame initializes ``game_interface`` to None.  Keep the
        # parser resolved above instead of accidentally discarding it.
        self.game_interface = resolved_game_interface
        self.game_state = [
            {
